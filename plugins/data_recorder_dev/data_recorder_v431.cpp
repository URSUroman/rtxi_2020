...
const char TEMP_FILE[45] = "Second_bird_syl_a_1.txt"; //"Template_syl_5_short_I_20_02_2019.txt";
const int MS_IN_SPECT = 55;//50;//55;		// in ms
const int SPECT_PERIOD = 1000;		// in us

// Parameters: Trigger
double corr_coeff_trig = 0.72;//0.74;		// Correlation to Template needed for Detection
...
//const int CORR_PTS =  1000 * MAX_FILE_SECS; //Nb of ms in 25 sec
