...
const double RMS_THRESHOLD = 0.045; //0.045 if ventilator out/working correctly and rms with 200 points; threshold to start recording
...
const double RMS_TERM_THRES = 0.040; //0.05;//.85;	// in Volts, threshold to stop recording (if under, stops)
...
const char TEMP_FILE[45] = "SB12_fl_1587029880_tm_77600_79600.txt";//"Seventh_Bird_20k_108900_110900.txt";//"Sixth_Bird_20k_128772_130772.txt";//"Sixth_Bird_20k_142786_144786.txt";//"Fifth_Bird_20k_64000_66000.txt"; //"Gris1Vert2_20k_70250_72250.txt";//"Gris1Vert2_20k_106700_108000.txt";//"Gris1Vert2_20k_62500_64500.txt";//"Second_bird_syl_a_1.txt";//"Template_2.txt"; //"LowerHalfTemp.Det";	// Template File (Raw Data)
...
//********************************************
double Amp_th = 3e-4;//1e-3 (for sixth bird) ;//5e-4(for fifth bird);//6e-4;//2.5e-3;//2e-5; Fifth Bird: 5e-4 
