...
const char TEMP_FILE[45] = "./workspace/rtxi/Template_2.txt"; //"LowerHalfTemp.Det";	// Template File (Raw Data)
...
const char PLAYBACK_FILE[45] = "./workspace/rtxi/Noise.txt"; //"thisSyl"; // File for Feedback
