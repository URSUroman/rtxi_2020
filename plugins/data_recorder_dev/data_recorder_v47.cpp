...
const char TEMP_FILE[45] = "Gris1Vert2_20k_106700_108000.txt";//"Gris1Vert2_20k_70250_72250.txt";//"Gris1Vert2_20k_106700_108000.txt";"Gris1Vert2_20k_62500_64500.txt";//"Second_bird_syl_a_1.txt";//"Template_2.txt"; //"LowerHalfTemp.Det";	// Template File (Raw Data)
const int MS_IN_SPECT = 50; //Template_2 with 32 ms		// in ms
const int SPECT_PERIOD = 1000;		// in us

// Parameters: Trigger
double corr_coeff_trig = 0.79;//0.4;//0.62//0.74;		// Correlation to Template needed for Detection
...
double syl_th_duration = 3233;//corresponds to the nb of samples at 20000 Hz.
...
void Initialize()
{
	...
	last_time=(double)current_time_clean_song-11*60*60;//-60*60;
